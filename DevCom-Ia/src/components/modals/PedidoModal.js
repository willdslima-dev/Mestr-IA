    ...
    if (isOpen) {
      ...
      if (pedidoExistente) {
        setFormData({
          ...
          desconto: pedidoExistente.desconto || 0,
              ...
              <div style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '10px' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <input
                      ...
                      onChange={(e) => updateFormData('desconto', parseFloat(e.target.value) || 0)}
                      placeholder="0,00"
                      step="0.01"
                      min="0"
                      style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '18px', fontWeight: '700', color: 'var(--accent)' }}>
                    R$ {(totais.subtotal - formData.desconto + formData.taxaEntrega + formData.outrasTaxas).toFixed(2).replace('.', ',')}
                  </span>
                </div>
              </div>
            )}
